...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Calculator myCalculator = new Calculator();
         ...
         System.out.println(myCalculator.perimetruPatrat(10));
         System.out.println(myCalculator.perimetruCerc(15.0));
         System.out.println(myCalculator.celMaiMareNr(60, 30, 40));
